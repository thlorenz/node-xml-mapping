...
exports['t03c'] = function (test) {
	...
	test.deepEqual(XMLMapping.load(input), { key : [{ __t : 'value1'}, { __t : 'value2'}] }); 
	input = '<key>value1</key><key>value2</key><key>value3</key>';
	test.deepEqual(XMLMapping.load(input), { key : [{ __t : 'value1'}, { __t : 'value2'}, { __t : 'value3'}] }); 
	test.done();
};
exports['t03d'] = function (test) {
	input = '<key><!--value1--></key>';
	test.deepEqual(XMLMapping.load(input), { key : { __c : 'value1'} }); 
	input = '<key><!--value1--><!--value2--></key>';
	test.deepEqual(XMLMapping.load(input), { key : { __c : ['value1','value2'] } }); 
	input = '<key><!--value1--></key><key><!--value2--></key>';
	test.deepEqual(XMLMapping.load(input), { key : [{ __c : 'value1'}, { __c : 'value2'}] }); 
	input = '<key><!--value1--></key><key><!--value2--></key><key><!--value3--></key>';
	test.deepEqual(XMLMapping.load(input), { key : [{ __c : 'value1'}, { __c : 'value2'}, { __c : 'value3'}] }); 
	test.done();
};
exports['t03e'] = function (test) {
	input = '<key><![CDATA[value1]]></key>';
	test.deepEqual(XMLMapping.load(input), { key : { __cd : 'value1'} }); 
	input = '<key><![CDATA[value1]]><![CDATA[value2]]></key>';
	test.deepEqual(XMLMapping.load(input), { key : { __cd : ['value1', 'value2']} }); 
	input = '<key1><key2><![CDATA[value1]]></key2><key3><![CDATA[value2]]></key3></key1>';
	test.deepEqual(XMLMapping.load(input), { key1 : { key2 : { __cd : 'value1'}, key3 : { __cd : 'value2'} } }); 
	input = '<key><![CDATA[value1]]></key><key><![CDATA[value2]]></key><key><![CDATA[value3]]></key>';
	test.deepEqual(XMLMapping.load(input), { key : [{ __cd : 'value1'}, { __cd : 'value2'}, { __cd : 'value3'}] }); 
	test.done();
};
exports['t04'] = function (test) {
	input = '<?xml version="1.0" encoding="UTF-8"?>\n<key1 key2="value1"><key3>value2</key3></key1>';
	test.deepEqual(XMLMapping.load(input), { key1 : { key2 : 'value1', key3 : { __t : 'value2'} } }); 
	input = '<key1 key2="value1"><key3>value2</key3></key1>';
	test.deepEqual(XMLMapping.load(input), { key1 : { key2 : 'value1', key3 : { __t : 'value2'} } }); 
	input = '<key1 key2="value1"><key3><key4>value2</key4></key3></key1>';
	test.deepEqual(XMLMapping.load(input), { key1 : { key2 : 'value1', key3 : { key4 : { __t : 'value2'} } } }); 
	input = '<key1 key2="value1"><key3><key4><key5>value2</key5></key4></key3></key1>';
	test.deepEqual(XMLMapping.load(input), { key1 : { key2 : 'value1', key3 : { key4 : { key5 : { __t : 'value2'} } } } }); 
	input = '<key1><key2 key3="value"><key4 key5="value" key6="value"><key7 key8="value" key9="value" key10="value">value</key7></key4></key2></key1>';
	test.deepEqual(XMLMapping.load(input), { key1 : { key2 : { key3 : 'value', key4 : { key5 : 'value', key6 : 'value', key7 : { key8 : 'value', key9 : 'value', key10 : 'value', __t : 'value' } } } } }); 
	test.done();
};
exports['t05'] = function (test) {
  input = '<key1><key2>value1</key2><key3>value2</key3></key1>';
  test.deepEqual(XMLMapping.load(input), { key1 : {  key2 : { __t : 'value1'}, key3 : { __t : 'value2'} } });
  input = '<key1 key2="value1"><key3>value2</key3><key4>value3</key4></key1>';
  test.deepEqual(XMLMapping.load(input), { key1 : { key2 : 'value1', key3 : { __t : 'value2'} , key4 : { __t : 'value3'} } });
  test.done();
};
